...
_unit addPrimaryWeaponItem "sp_fwa_1rnd_riflegrenade_mas_ap";
...
for "_i" from 1 to 9 do {_unit addItemToBackpack "sp_fwa_1rnd_riflegrenade_mas_ap";};
...
[_unit,"RussianHead_1","male01rus"] call BIS_fnc_setIdentity;
